                ...
                <div class="p-5">
                  ...
                  <form class="user" action="{{url('login')}}" method="POST">
                    <div class="form-group">
                      <input required type="email" class="form-control form-control-user" name="email" id="email" placeholder="Masukkan alamat email...">
                    </div>
                    <div class="form-group">
                      <input required name="password" id="password" type="password" class="form-control form-control-user" placeholder="Masukkan Password...">
                    </div>
